"""Compare instruction-quality Batch 001 with Batch 002."""
...
RESULT = Path(
    "evaluation/results/instruction_quality_batch_002_comparison_v1.json"
)
MANUAL_REVIEW = Path(
    "evaluation/results/"
    "instruction_quality_batch_002_comparison_v1_manual_review.txt"
)

CHECKPOINTS = {
    "instruction_quality_batch_001": Path(
        "checkpoints/vasu_60m/"
        "instruction_quality_batch_001_from_ultrachat_v2/best.pt"
    ),
    "instruction_quality_batch_002": Path(
        "checkpoints/vasu_60m/"
        "instruction_quality_batch_002_from_batch_001/best.pt"
    ),
}
EXPECTED_HASHES = {
    "instruction_quality_batch_001": (
        "4f377fc49fef2382c531b5bb28731fa9"
        "664bac217256b8a76dcf1427f4d39d8e"
    ),
    "instruction_quality_batch_002": (
        "5025c1690035f0f0139bb2cff4044fd4"
        "a0ef6df0e480eee71d96a12e61272262"
    ),
}
...
def manual_review_text(results: list[dict[str, Any]], prompts: list[dict[str, Any]]) -> str:
    ...
    lines = ["VASU INSTRUCTION-QUALITY BATCH 002 COMPARISON MANUAL REVIEW", "", "Reviewer: ", "Date: ", ""]
...
def promotion_assessment(
    ...
    by_name = {result["name"]: result for result in results}
    base = by_name["instruction_quality_batch_001"]
    candidate = by_name["instruction_quality_batch_002"]
    ...
    return {
        ...
        "main_checkpoint_recommendation": "instruction_quality_batch_001",
        "reason": (
...
def main() -> None:
    ...
    payload = {
        "format_version": (
            "instruction_quality_batch_002_comparison_v1"
        ),
