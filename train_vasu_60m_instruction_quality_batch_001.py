...
EXPERIMENT_NAME = "vasu_60m_instruction_quality_batch_001_from_ultrachat_v2"
BASE_CHECKPOINT = Path(
    "checkpoints/vasu_60m/ultrachat_masked_v2_from_alpaca_v3/best.pt"
)
BASE_GLOBAL_STEP = 201_301
BASE_CHECKPOINT_SHA256 = (
    "eea7669a4728e3fbc8e35320bce1c3683c4fa9a584d1eb2da566e8fdafab36a7"
)
TOKENIZER_FILE = Path("assets/tokenizer.json")
DATA_FILE = Path(
    "data/processed/instruct/vasu_instruction_quality_v1_batch_001.bin"
)
MASK_FILE = Path(
    "data/processed/instruct/vasu_instruction_quality_v1_batch_001_mask.bin"
)
RELEASE_MANIFEST_FILE = Path(
    "data/manifests/instruct/vasu_instruction_quality_v1_batch_001_release.json"
)
CHECKPOINT_DIR = Path(
    "checkpoints/vasu_60m/instruction_quality_batch_001_from_ultrachat_v2"
)
